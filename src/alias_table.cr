# Generated from go-enry go-enry/v2 (linguist commit 537297cdae3ab05f8d5dd1c03627a5bd73707b19) by scripts/extract_constants.py - do not edit.
module Hansa
  # Keys are lower case with whitespace replaced by
  # underscores, so lookups must convert first (see
  # .language_by_alias).
  LANGUAGE_BY_ALIAS = {
    ...
    "b3d"                                => "BlitzBasic",
    "b4x"                                => "B4X",
    "b_(formal_method)"                  => "B (Formal Method)",
    "ballerina"                          => "Ballerina",
    "bash"                               => "Shell",
    ...
    "mathematical_programming_system"    => "Mathematical Programming System",
    "matlab"                             => "MATLAB",
    "maven_pom"                          => "Maven POM",
    "max"                                => "Max",
    "max/msp"                            => "Max",
    ...
    "tabular_model_definition_language"  => "TMDL",
    "tact"                               => "Tact",
    "talon"                              => "Talon",
    "tcl"                                => "Tcl",
    "tcsh"                               => "Tcsh",
